...
- **spirit_po** tests run when compiled with SPIRIT_PO_NOEXCEPT and `-fno-exceptions` provided that boost version >= 1.55. (Fails below that due to a bug in boost::variant.)
